import { j as jsxRuntimeExports, r as reactExports, c as cn, a as reactDomExports, u as useRouter, S as Skeleton } from "./index-DNVH2Qkg.js";
import { L as Layout } from "./Layout-D3T6SkdV.js";
import { c as composeEventHandlers, e as createSlottable, d as createContextScope, a as Primitive, f as useLayoutEffect2, b as useControllableState, g as createSlot, u as ue } from "./index-CkPABtMy.js";
import { c as createLucideIcon, p as useComposedRefs, d as useProfile, B as useUpdateProfile, C as Card, m as CardHeader, n as CardTitle, a as CardContent } from "./createLucideIcon-BASLoXwI.js";
import { R as Root$1, b as Trigger$1, W as WarningProvider, C as Content$1, T as Title, D as Description, a as Close, c as createDialogScope, P as Portal$1, O as Overlay, u as useCallbackRef, d as useId, e as Portal$2, h as hideOthers, f as useFocusGuards, g as ReactRemoveScroll, F as FocusScope, i as DismissableLayer } from "./index-ebBrmsI9.js";
import { b as buttonVariants, B as Button } from "./button-CrkwacFM.js";
import { B as Badge } from "./badge-BhejcKYO.js";
import { I as Input } from "./input-7Yzeg1-J.js";
import { L as Label } from "./label-DEKBdpsS.js";
import { a as useSize, b as useDirection, c as createCollection, u as usePrevious, d as clamp$1, C as Check } from "./index-BthPjv5B.js";
...
function Settings() {
  ...
  const [editLifeStage, setEditLifeStage] = reactExports.useState("");
  const [isEditing, setIsEditing] = reactExports.useState(false);
  function startEdit() {
    setEditName((profile == null ? void 0 : profile.name) ?? "");
    setEditCity((profile == null ? void 0 : profile.city) ?? "");
    setEditLifeStage((profile == null ? void 0 : profile.lifeStage) ?? "");
    setIsEditing(true);
  }
  async function saveEdit() {
    await updateProfile.mutateAsync({
      name: editName.trim() || void 0,
      city: editCity.trim() || void 0,
      lifeStage: editLifeStage || void 0
    });
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Layout, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-2xl mx-auto px-4 pt-6 pb-4 space-y-5", children: [
    ...
    isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "border-border shadow-sm", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "space-y-4", children: isEditing ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "edit-name", className: "font-body text-sm", children: "Name" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Input,
              {
                id: "edit-name",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "edit-city", className: "font-body text-sm", children: "City" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Input,
              {
                id: "edit-city",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "font-body text-sm", children: "Life Stage" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Select,
              {
                value: editLifeStage,
                onValueChange: (v) => setEditLifeStage(v),
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    SelectTrigger,
                    {
                      ...
                      children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, { placeholder: "Select life stage" })
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(SelectContent, { children: LIFE_STAGES.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                    SelectItem,
                    {
                      value: s,
                      className: "font-body text-sm",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 rounded-full bg-primary flex items-center justify-center text-primary-foreground text-lg font-semibold font-display", children: profile == null ? void 0 : profile.name.charAt(0).toUpperCase() }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-semibold text-foreground", children: profile == null ? void 0 : profile.name }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-muted-foreground font-body", children: [
                "Age ",
                profile == null ? void 0 : profile.age,
                " · ",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground font-body", children: "Life stage" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Badge,
                {
                  variant: "secondary",
                  className: "mt-1 font-body text-xs",
                  children: profile == null ? void 0 : profile.lifeStage
                }
              )
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-right", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground font-body", children: "BMI" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold font-body text-foreground mt-0.5", children: profile ? (profile.weightKg / (profile.heightCm / 100) ** 2).toFixed(1) : "—" })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "border-border shadow-sm", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "space-y-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground font-body leading-relaxed", children: "Your health data is stored securely on your device and never shared with third parties. CyraSense AI is not a medical device and does not provide medical diagnoses." }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "border-border shadow-sm", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { className: "pb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardTitle, { className: "text-sm font-display flex items-center gap-2", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-body text-foreground", children: (profile == null ? void 0 : profile.city) ?? "Not set" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground font-body mt-1", children: "Used to suggest nearby healthcare resources." })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialog, { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogContent, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogHeader, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialogTitle, { className: "font-display", children: "Clear all data?" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialogDescription, { className: "font-body", children: "This will remove your profile and all health tracking data from this device. This action cannot be undone." })
          ] }),
